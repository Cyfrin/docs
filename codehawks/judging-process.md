...
**Valid Findings:**
When a submission is deemed valid, judges assign a "Finding Tag" that categorizes the vulnerability and indicates its type and severity level.

**Invalid Findings:**
Submissions deemed invalid receive an "invalidation reason" label. Judges may provide additional explanatory comments about the rejection.
